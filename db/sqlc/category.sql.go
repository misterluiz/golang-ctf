...
INSERT INTO categories(
    ...
    $1, $2, $3, $4  
)RETURNING id, user_id, tytle, type, description, created_at
`
...
UPDATE categories SET tytle = $2, description = $3 WHERE id = $1 RETURNING id, user_id, tytle, type, description, created_at
`
...
func (q *Queries) UpdateCategories(ctx context.Context, arg UpdateCategoriesParams) (Category, error) {
	row := q.db.QueryRowContext(ctx, updateCategories, arg.ID, arg.Tytle, arg.Description)
	var i Category
	err := row.Scan(
		&i.ID,
		&i.UserID,
